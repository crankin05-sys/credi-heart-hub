...
const pageTitles: Record<string, { title: string; subtitle?: string }> = {
  ...
  businesses: { title: 'All Businesses — Complete Fundability View', subtitle: '10 businesses tracked · Click any business to view full checklist' },
  pipeline: { title: 'Fundability Pipeline', subtitle: 'Drag-and-drop pipeline view of all businesses' },
