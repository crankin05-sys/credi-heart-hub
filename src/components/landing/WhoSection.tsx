            ...
            <div className="glass-card rounded-xl p-8 group h-full relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2">
                  {p.tags.map((t) => (
                    <span key={t} className="text-[10px] font-semibold px-3 py-1.5 bg-primary/[0.08] border border-primary/20 text-primary/80 rounded-full tracking-wide group-hover:bg-primary/15 group-hover:border-primary/30 transition-all">{t}</span>
                  ))}
                </div>
              </div>
            </div>
