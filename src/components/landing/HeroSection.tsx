    ...
    <section className="min-h-screen flex items-center px-6 md:px-10 pt-28 pb-24 relative overflow-hidden bg-[#0a1628]">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <ScrollReveal>
              <div className="inline-flex items-center gap-2.5 bg-white/[0.08] backdrop-blur-sm border border-white/10 rounded-full text-[#7db4ff] text-[13px] font-bold px-5 py-2.5 tracking-[2px] uppercase mb-8">
            ...
            <ScrollReveal delay={0.2}>
              <p className="text-[18px] text-white/80 leading-[1.85] max-w-[520px] mb-10">
            ...
            <ScrollReveal delay={0.3}>
              <div className="flex gap-4 flex-wrap mb-12">
                <button
                  ...
                  className="group relative bg-gradient-to-r from-[#2563eb] to-[#1d4ed8] text-white text-[15px] font-bold px-8 py-4 border-none cursor-pointer rounded-xl transition-all duration-300 hover:shadow-[0_12px_40px_hsl(220_80%_50%/0.35)] hover:-translate-y-1 inline-flex items-center gap-2.5 overflow-hidden"
                >
                ...
                <button
                  ...
                  className="group bg-white/[0.08] text-white/90 border border-white/15 text-[15px] font-semibold px-7 py-4 cursor-pointer rounded-xl transition-all duration-300 hover:border-white/30 hover:text-white hover:bg-white/[0.12]"
                >
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/10 backdrop-blur-xl rounded-xl border border-white/15 p-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-white text-[15px] font-bold">Funding Readiness: Strong</div>
                      <div className="text-white/70 text-[13px]">Business Model Canvas complete · 3 next steps ready</div>
                    </div>
        ...
        <ScrollReveal delay={0.5}>
          <div className="grid grid-cols-3 bg-white/[0.06] backdrop-blur-sm border border-white/[0.1] rounded-xl max-w-[520px] overflow-hidden mt-8 md:mt-0">
            {[
              { n: '✓', l: 'Live Dashboard', icon: '📊' },
              { n: '24/7', l: 'Guidance', icon: '🧭' },
              { n: '∞', l: 'Growth Tools', icon: '📈' },
            ].map((s, i) => (
              <div key={i} className={`px-6 py-6 text-center group hover:bg-white/[0.04] transition-all duration-300 ${i < 2 ? 'border-r border-white/[0.1]' : ''}`}>
                ...
                <div className="text-[13px] text-white/60 uppercase tracking-[1.5px] mt-1.5">{s.l}</div>
              </div>
            ))}
          </div>
        </ScrollReveal>
